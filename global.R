...
avail_portals <- list(
  eve_cal = list(
    ...
    bg_color = "rgba(173,255,47,1)",    # overrided by brewed color
  ...
  trd_ptl = list(
    ...
    bg_color = "rgba(176,224,230,1)",   # overrided by brewed color
    ft_color = "rgba(80,80,80,1)",      # dark gray
    active = 1
  ),
  tm_trkr = list(
    ...
    bg_color = "rgba(248,185,212,1)",   # overrided by brewed color   
    ft_color = "rgba(80,80,80,1)",      # dark gray
    active = 1
  ),
  pmp = list(
    ...
    bg_color = "rgba(252,74,0,1)",       # overrided by brewed color
  ...
  dt_pkr = list(
    ...
    bg_color = "rgba(143,29,33,1)",      # overrided by brewed color  
    ft_color = "rgba(255,255,255,1)",    # white
    active = 1
  ),
  proj04 = list(
    ...
    bg_color = fp_color,                # overrided by brewed color
    ft_color = "rgba(80,80,80,1)",      # dark gray
    active = 1
  ),
  proj05 = list(
